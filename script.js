...
function createcountry({
  ...
  document.body.innerHTML += ` <div class="container">
    <div class="card1"  >
    <h1 id="title" class="name">${name}</h1>
    <img src="${flag}" class="flag" alt="${name}'Flag image">
  <div class="card-body car" >
  <p   class=country><span>Captial :</span> ${capital}</p>
  <p   class=country><span>Region :</span> ${region}</p>
  <p   class=country><span>Country Code :</span>${code}</p>
  <a href="#" class="a" onclick=(block(${latitude},${longitude},${name})) >Click for Weather</a>
 <div id=${name}>   </div>
